 ...
 *
 */
@WebFilter(filterName="signnatureFilter", urlPatterns={"*.css","*.js","*.png"})
public class signnatureFilter implements Filter {
	/**
	 * 一周間キャッシュするため
	 */
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if ("css".equals(ex)){
			resourcePath="signature/resource/client/"+filename;
